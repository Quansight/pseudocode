...
def create_python_function_from_openai_messages(messages: typing.List[OpenAIMessage], review: bool = False):
    ...
    try:
        ...
        raise OpenAIException(
            f"I ran into an exeption when I tried to execte the code you supplied. Could you try an fix it? Here is the exception {e}"
        )
        ...
        try:
            ...
            for test_case, result in test_cases:
                ...
                try:
                    ...
                    raise OpenAIException(
                        f"The following python test case `{test_case} == {result}` failed and raised an exception. The exception was of type {type(e)} and the brief exception message was {e}"
                    )
